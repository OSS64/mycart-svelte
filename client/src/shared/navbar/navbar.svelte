  ...
  <Navbar color="light" light expand="md" class="custom-navbar shadow-sm">
    <div class="container">
      ...
      <Collapse
        ...
        navbar
        expand="md"
        on:update="{navCollapseOpener}"
      >
        <Nav class="ms-auto" navbar>
          <NavItem class="mlmr-3">
            <NavLink href="javascript:void(0)" on:click="{() => navigate('/')}"
              >Home</NavLink
            >
          </NavItem>
          <NavItem class="mlmr-3">
          ...
          <NavItem class="mlmr-3 d-none d-lg-block">
          ...
          <NavItem class="mlmr-3">
            <NavLink disabled>Hello, {user.username}</NavLink>
          </NavItem>
          <NavItem class="mlmr-3">
            {#if isAuthonicated}
              <Confirm
