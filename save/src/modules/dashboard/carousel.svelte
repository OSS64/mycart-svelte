<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <div class="img-height">
        <img
          src="/content/images/processor.jpg"
          class="d-block w-100"
          alt="processor"
        />
      </div>
      <div class="carousel-caption d-none d-md-block">
        <h5>Processors</h5>
        <p>
          The very best in computing with the latest processors from Intel,AMD
          and more.
        </p>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="img-height">
        <img
          src="/content/images/peripherals.jpg"
          class="d-block w-100"
          alt="peripherals"
        />
      </div>
      <div class="carousel-caption d-none d-md-block">
        <h5>Peripherals</h5>
        <p>
          All the necessary peripherals for you PC/Laptop from mouse and
          keyboard to earphones and speakers.
        </p>
      </div>
    </div>
    <div class="carousel-item">
